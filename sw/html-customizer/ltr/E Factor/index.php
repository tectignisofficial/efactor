  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-12">
      <div class="card">
        ...
        <div class="card-body">
          <div style="height:355px"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas class="radar-chart-ex chartjs chartjs-render-monitor" id="canvas" data-height="355" width="551" height="355" style="display: block; width: 551px; height: 355px;"></canvas></div>
        </div>
      </div>
    </div>
    <!-- Radar Chart Ends-->
    ...
    <div class="col-lg-6 col-12">
      <div class="card">
        <div class="card-header">
          ...
          <div class="dropdown">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical cursor-pointer" role="button" id="heat-chart-dd" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg>
        ...
        <div class="card-body">
          <div style="height:350px"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas class="polar-area-chart-ex chartjs chartjs-render-monitor" data-height="350" width="551" height="350" style="display: block; width: 551px; height: 350px;"></canvas></div>
        </div>
      </div>
    </div>
